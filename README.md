...
3. Set up additional dependencies for external datasets and data sources (e.g., Matbench, Materials Project)

**⚠️Important**: Since there are dependency conflicts between different backbone models, we strongly recommend our user to create seperate virtual environment for each backbone model to be used
