...
BackBoneBaseOutput = TypeVar(
    "BackBoneBaseOutput", bound=BackBoneBaseOutputProtocol, infer_variance=True
)
...
class BackBoneBaseModule(ABC, Generic[TBatch, BackBoneBaseOutput], nn.Module):
    ...
    @abstractmethod
    def process_batch_under_grad(self, batch: TBatch, training: bool) -> TBatch: ...
