...
if typ.TYPE_CHECKING:
    from mattertune.backbones.m3gnet.model import M3GNetBackboneConfig
...
# Schema entries
class M3GNetBackboneConfigTypedDict(typ.TypedDict, total=False):
...
@typ.overload
def CreateM3GNetBackboneConfig(
    dict: M3GNetBackboneConfigTypedDict, /
) -> M3GNetBackboneConfig: ...


@typ.overload
def CreateM3GNetBackboneConfig(
    **dict: typ.Unpack[M3GNetBackboneConfigTypedDict],
) -> M3GNetBackboneConfig: ...


def CreateM3GNetBackboneConfig(*args, **kwargs):
    from mattertune.backbones.m3gnet.model import M3GNetBackboneConfig

    dict = args[0] if args else kwargs
    return M3GNetBackboneConfig.model_validate(dict)
