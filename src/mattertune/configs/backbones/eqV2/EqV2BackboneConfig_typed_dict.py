...
if typ.TYPE_CHECKING:
    from mattertune.backbones.eqV2.model import EqV2BackboneConfig
...
# Schema entries
class EqV2BackboneConfigTypedDict(typ.TypedDict, total=False):
...
@typ.overload
def CreateEqV2BackboneConfig(
    dict: EqV2BackboneConfigTypedDict, /
) -> EqV2BackboneConfig: ...


@typ.overload
def CreateEqV2BackboneConfig(
    **dict: typ.Unpack[EqV2BackboneConfigTypedDict],
) -> EqV2BackboneConfig: ...


def CreateEqV2BackboneConfig(*args, **kwargs):
    from mattertune.backbones.eqV2.model import EqV2BackboneConfig

    dict = args[0] if args else kwargs
    return EqV2BackboneConfig.model_validate(dict)
