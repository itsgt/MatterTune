...
if typ.TYPE_CHECKING:
    from mattertune.finetune.base import FinetuneModuleBaseConfig
...
# Schema entries
class FinetuneModuleBaseConfigTypedDict(typ.TypedDict, total=False):
...
@typ.overload
def CreateFinetuneModuleBaseConfig(
    dict: FinetuneModuleBaseConfigTypedDict, /
) -> FinetuneModuleBaseConfig: ...


@typ.overload
def CreateFinetuneModuleBaseConfig(
    **dict: typ.Unpack[FinetuneModuleBaseConfigTypedDict],
) -> FinetuneModuleBaseConfig: ...


def CreateFinetuneModuleBaseConfig(*args, **kwargs):
    from mattertune.finetune.base import FinetuneModuleBaseConfig

    dict = args[0] if args else kwargs
    return FinetuneModuleBaseConfig.model_validate(dict)
