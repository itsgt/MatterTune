...
if typ.TYPE_CHECKING:
    from mattertune.backbones.orb.model import ORBBackboneConfig
...
# Schema entries
class ORBBackboneConfigTypedDict(typ.TypedDict, total=False):
...
@typ.overload
def CreateORBBackboneConfig(
    dict: ORBBackboneConfigTypedDict, /
) -> ORBBackboneConfig: ...


@typ.overload
def CreateORBBackboneConfig(
    **dict: typ.Unpack[ORBBackboneConfigTypedDict],
) -> ORBBackboneConfig: ...


def CreateORBBackboneConfig(*args, **kwargs):
    from mattertune.backbones.orb.model import ORBBackboneConfig

    dict = args[0] if args else kwargs
    return ORBBackboneConfig.model_validate(dict)
